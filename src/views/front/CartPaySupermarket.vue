...
<div class="container">
    ...
    <div class="card mt-3" style="">
      ...
      <div class="row g-3 m-4">
        <div class="col-md-4 d-flex justify-content-center">
          <img src="https://payment.ecpay.com.tw/Content/themes/RWD/images/frame/pp02.png" class="img-fluid rounded-start" alt="...">
        </div>
        <div class="col-md-4 d-flex justify-content-center">
          <img src="https://payment.ecpay.com.tw/Content/themes/RWD/images/frame/pp03.png" class="img-fluid rounded-start" alt="...">
        </div>
        <div class="col-md-4 d-flex justify-content-center">
          <img src="https://payment.ecpay.com.tw/Content/themes/RWD/images/frame/pp04.png" class="img-fluid rounded-start" alt="...">
        </div>
      </div>
    </div>
    <div class='mt-3 bg-light text-dark'>
      <div class='p-3'>
        ...
        <ul class='text-secondary fw-lighter'>
          ...
          <li>例：08 / 01的20: 15分購買商品，繳費期限為7天，表示8 / 08的20: 15分前您必須前往繳費。</li>
          <li>請務必於期限內進行繳款，若超過繳費截止時間請勿繳款，以免造成訂單異常。</li>
          <li>提醒您！超商店員不會在結帳時另收手續費。</li>
          <li>若超商繳費連結逾時無法繳費，請點選連結內"重新取得繳費條碼"按鈕。</li>
        </ul>
      </div>
    </div>
</div>
